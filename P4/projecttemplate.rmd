...
The distribution of complaints per state looks interesting. São Paulo is the state
with most complaints, but also is the most populous state in Brazil: https://en.wikipedia.org/wiki/List_of_Brazilian_states_by_population
Pernambuco is in the second state with most complaints, but only the 7th
in the population ranking. In the final plots, I will investigate this behavior
further.
